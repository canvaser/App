...
import com.summer.lib.ui.ope.BaseDAOpe;
import com.summer.lib.ui.ope.CommonOpes;
import com.summer.lib.ui.ope.BaseUIOpe;
import com.summer.lib.ui.interf.FragIntef;
...
public abstract class BaseUIFrag<A extends BaseUIOpe, B extends BaseDAOpe> extends BaseFrg implements View.OnClickListener, MaterialRefreshListener, BottomFinishView.Finish {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        parent.addView(getUIBean(false).getView(), new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
        unbinder = ButterKnife.bind(this, group);
        return group;
    }

    public abstract BaseUIBean getUIBean(boolean create);
