package com.siweisoft.nurse.ui.info.shiftdutereport.ope;
 ...
 */
public class ShiftDuteReportNetOpe extends BaseNetOpe{


    public ShiftDuteReportNetOpe(Context context) {
        super(context);
    }
