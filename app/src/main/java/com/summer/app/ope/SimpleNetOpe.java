package com.summer.app.ope;

import android.content.Context;

import com.alibaba.fastjson.JSONArray;
import com.summer.app.ui.addwater.addaddwater.bean.netbean.AddAddWaterReqBean;
import com.summer.app.ui.addwater.addaddwater.bean.netbean.AddAddWaterResBean;
import com.summer.app.ui.bed.addmypatient.bean.MyPaitentUpdateListReqBean;
import com.summer.app.ui.bed.advice.bean.reqbean.AdviceTaskBean;
import com.summer.app.ui.bed.data.bean.resbean.DataTemplateDataResBean;
import com.summer.app.ui.bed.data.bean.resbean.DataTemplateResBean;
import com.summer.app.ui.bed.inputdata.bean.reqbean.InputDataReqBean;
import com.summer.app.ui.check.checkblood.bean.CheckPatAndPipeReqBean;
import com.summer.app.ui.check.patientcheck.bean.PatAndTaskInfoByDocAdvIdReqBean;
import com.summer.app.ui.info.adddutereport.bean.AddDuteReportReqBean;
...
import com.summer.app.ui.addwater.addaddwater.bean.netbean.AddAddWaterDataReqBean;
import com.summer.app.ui.addwater.addaddwater.bean.netbean.GetBylReqBean;
import com.summer.app.ui.addwater.addwater.bean.netbean.AddWaterReqBean;
import com.summer.app.ui.bed.persontask.bean.reqbean.GetPatientTaskOfTodayReqBean;
import com.summer.app.ui.bed.persontask.bean.reqbean.GetPatientTaskReqBean;
...
import com.summer.app.ui.bed.data.bean.reqbean.JsonDataListReqBean;
import com.summer.app.ui.bed.data.bean.reqbean.RecordDataReqBean;
import com.summer.app.ui.bed.datachart.bean.reqbean.DataChartReqBean;
import com.summer.app.ui.bed.inputdata.bean.reqbean.InputDataListReqBean;
...
import com.summer.app.ui.bed.patient.bean.reqbean.PatientAdditionReqBean;
import com.summer.app.ui.check.checklist.bean.reqbean.UpdateCheckListReqBean;
import com.summer.app.ui.document.document.bean.netbean.DocumentDetailReqBean;
import com.summer.app.ui.document.document.bean.netbean.DocumentListReqBean;
import com.summer.app.ui.home.bean.reqbean.UpdateCallingLogsReqBean;
...
import com.summer.app.ui.mission.missionlist.bean.req.MyWardTaskTodayReqBean;
...
import com.summer.app.ui.user.login.bean.DoLoginReqBean;
import com.summer.app.ui.user.login.bean.GetallregionbyuserNetBean;
...
public class SimpleNetOpe extends BaseNetOpe {
    ...
    //补液卡列表
    public static void addwater_list_ward(Context context, String ward, String fileid, String begin, String end, OnNetWorkReqInterf reqInterf) {
        AddWaterReqBean baseReqBean = new AddWaterReqBean();
        baseReqBean.setWard(ward);
        baseReqBean.setFileid(fileid);
        baseReqBean.setBegin(begin);
        baseReqBean.setEnd(end);
        NetWork.getInstance(context).doHttpRequsetWithSession(context, DataValue.URL_GET_FILE_DATA_BY_PATIENT, baseReqBean, reqInterf);
