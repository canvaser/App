package com.summer.app.ui.bed.inputdata.adapter;
...
import com.summer.app.ui.bed.inputdata.bean.uibean.InputDataUIBean;
                ...
                uiBean.getValueTV().setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(final View v) {
                        DialogUtil.showTimePick(context, fragmentActivity.getSupportFragmentManager(), "date", Type.ALL, new OnDateSetListener() {
                            @Override
                            public void onDateSet(com.summer.lib.view.pickerview.TimePickerDialog timePickerView, long millseconds) {
