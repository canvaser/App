package com.siweisoft.nurse.ui.index.adapter;
...
import com.siweisoft.nurse.ui.index.bean.PupListUIBean;
...
public class PupListAdapter extends AppRecycleAdapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = layoutInflater.inflate(R.layout.list_pop, null);
