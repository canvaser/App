...
import com.summer.nurse.ui.day.ope.uiope.RightDayUIOpe;
...
public class RightDayFrag extends BaseNurseFragWithoutTitle<RightDayUIOpe, BaseNetOpe, DayAddDBOpe, BaseDAOpe> implements OnAppItemLongClickListener {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        getOpe().getBaseNurseUIOpe().initList(getOpe().getBaseDBOpe().getAfter(FormatUtil.getInstance().getNowHHMMTime()));
        ...
        getOpe().getBaseNurseUIOpe().getRefreshLayout().setMaterialRefreshListener(new MaterialRefreshListener() {
            ...
            public void onRefresh(MaterialRefreshLayout materialRefreshLayout) {
                ...
                ((LeftDayAdapter) getOpe().getBaseNurseUIOpe().getRecyclerView().getAdapter()).setLongClickListener(RightDayFrag.this);
            }
        });
    }
    ...
    public BaseNurseOpes<RightDayUIOpe, BaseNetOpe, DayAddDBOpe, BaseDAOpe> getOpe() {
        if (baseNurseOpes == null) {
            baseNurseOpes = new BaseNurseOpes(new RightDayUIOpe(activity, getView()), null, new DayAddDBOpe(activity, new DayDBBean()), null);
        }
