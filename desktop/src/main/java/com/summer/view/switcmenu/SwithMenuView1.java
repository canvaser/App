package com.summer.view.switcmenu;
...
public class SwithMenuView1 extends LinearLayout implements View.OnClickListener {
    ...
    private void init() {
        ...
        for (int i = 0; i < strings.size(); i++) {
            ...
            viewGroup.addView(view, new LinearLayout.LayoutParams(0, ViewGroup.LayoutParams.MATCH_PARENT, 1));
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        LinearLayout.LayoutParams params = (LayoutParams) lineView.getLayoutParams();
