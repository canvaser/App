...
public interface DatabaseResultsMapper<T> {
     ...
     *
     * @param databaseResults The results entry that is currently being iterated. You must not advance or call any of the other move
     *                        operations on this parameter.
     * @return The value to return for this row to be included in the raw results iterator.
     * @throws SQLException If there is any critical error with the data and you want to stop the paging.
     */
