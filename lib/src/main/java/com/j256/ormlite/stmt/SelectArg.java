...
public class SelectArg extends BaseArgumentHolder {
     ...
     * methods.
     *
     * @param columnName Name of the column this argument corresponds to.
     * @param value      Value for the select-arg if know at time of construction. Otherwise call {@link #setValue(Object)}
     *                   later.
     */
     ...
     * methods.
     *
     * @param sqlType Type of the column that this argument corresponds to. Only necessary if you are using the
