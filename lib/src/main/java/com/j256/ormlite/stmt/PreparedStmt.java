...
public interface PreparedStmt<T> extends GenericRowMapper<T> {
     ...
     *
     * @param resultFlags Set to -1 for default.
     */
     ...
     * </p>
     *
     * @param index The index of the holder you are going to set, 0 based. See NOTE above.
     * @param value Object to set in the argument holder.
     */
