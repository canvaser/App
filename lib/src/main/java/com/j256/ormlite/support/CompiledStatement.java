...
public interface CompiledStatement extends Closeable {
     ...
     *
     * @param parameterIndex Index of the parameter with 0 being the first parameter, etc..
     * @param obj            Object that we are setting. Can be null.
     * @param sqlType        SQL type of the parameter.
     */
