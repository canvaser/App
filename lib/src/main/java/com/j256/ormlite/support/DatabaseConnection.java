...
public interface DatabaseConnection extends Closeable {
     ...
     *
     * @param savePointName to use for the Savepoint although it can be ignored.
     ...
     *
     * @param resultFlags Allows specification of some result flags. This is dependent on the backend and database type. Set to
     ...
     * @param resultFlags Allows specification of some result flags. This is dependent on the backend and database type. Set to
     *                    {@link #DEFAULT_RESULT_FLAGS} for the internal default.
     * @param cacheStore  Cache can store results from this statement.
     */
     ...
     *
     * @param statement     SQL statement to use for inserting.
     * @param args          Object arguments for the SQL '?'s.
     * @param argfieldTypes Field types of the arguments.
     * @param keyHolder     The holder that gets set with the generated key value which may be null.
     ...
     *
     * @param statement     SQL statement to use for updating.
     * @param args          Object arguments for the SQL '?'s.
     * @param argfieldTypes Field types of the arguments.
     * @return The number of rows affected by the update. With some database types, this value may be invalid.
     */
     ...
     *
     * @param statement     SQL statement to use for deleting.
     * @param args          Object arguments for the SQL '?'s.
     * @param argfieldTypes Field types of the arguments.
     * @return The number of rows affected by the update. With some database types, this value may be invalid.
     */
     ...
     * @param args          Object arguments for the SQL '?'s.
     * @param argfieldTypes Field types of the arguments.
     * @param rowMapper     The mapper to use to convert the row into the returned object.
     * @param objectCache   Any object cache associated with the query or null if none.
     ...
     *
     * @param statement SQL statement to use for the query.
     */
     ...
     *
     * @param statement     SQL statement to use for the query.
     * @param args          Arguments to pass into the query.
     * @param argFieldTypes Field types that correspond to the args.
     */
