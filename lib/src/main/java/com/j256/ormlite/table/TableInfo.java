...
public class TableInfo<T, ID> {
     ...
     * @param baseDaoImpl      Associated BaseDaoImpl.
     * @param dataClass        Class that we are holding information about.
     */
     ...
     * Creates a holder of information about a table/class.
     *
     * @param databaseType Database type we are storing the class in.
     * @param baseDaoImpl  Associated BaseDaoImpl.
     * @param tableConfig  Configuration for our table.
     */
