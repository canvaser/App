...
public class FieldType {
     ...
     *
     * @param parent The parent object that we will set on each item in the collection.
     * @param id     The id of the foreign object we will look for. This can be null if we are creating an empty
     *               collection.
     */
