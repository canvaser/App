 ...
 */
package com.siweisoft.lib.view.other;
...
public class RoundRectDrawableWithShadow extends Drawable {
    ...
    * */
    ...
    public RoundRectDrawableWithShadow(
        ...
        mShadowStartColor = resources.getColor(R.color.red);
        mShadowEndColor = resources.getColor(R.color.blue);
        mInsetShadow = resources.getDimensionPixelSize(R.dimen.dimen_1);
