package com.siweisoft.lib.view.pinnedheaderexpandablelistview.expandable;
...
import com.siweisoft.lib.view.pinnedheaderexpandablelistview.expandable.ui.StickyLayout;
    ...
    class MyexpandableListAdapter extends BaseExpandableListAdapter {
        ...
        public View getGroupView(int groupPosition, boolean isExpanded,
            ...
            if (isExpanded)// ture is Expanded or false is not isExpanded
                groupHolder.imageView.setImageResource(R.drawable.icon_arraw);
            else
                groupHolder.imageView.setImageResource(R.drawable.icon_arraw);
            return convertView;
        }
